...
import { assertNavigationAvailable, installInterceptor, navTo, seedHistory, traverseTo, traverseToStart, uninstallInterceptor, waitForNavigateSuccess } from './common/utils';
...
describe('Anchor - traverse', () => {
  ...
  it('traverse without hints moves to the previous existing entry without growing history', async () => {
    await seedHistory();
